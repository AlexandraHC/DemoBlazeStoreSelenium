...
public class LoginPage
{
    ...
    public IWebElement NavBar => _driver.FindElement(By.Id("navbarExample"));
    ...
    public IWebElement LoginLink => NavBar.FindElement(By.Id("login2"));
    ...
    public IWebElement LogoutLink => NavBar.FindElement(By.Id("logout2"));
